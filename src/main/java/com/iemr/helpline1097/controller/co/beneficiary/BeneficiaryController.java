...
import com.iemr.helpline1097.service.co.beneficiary.IEMRBenDemographicsServiceImpl;
...
public class BeneficiaryController
{
	...
	private IEMRBeneficiaryOccupationServiceImpl iEMRBeneficiaryOccupationServiceImpl;
	private IEMRBeneficiaryEducationServiceImpl iEMRBeneficiaryEducationServiceImpl;
	private IEMRBenDemographicsServiceImpl iEMRBenDemographicsServiceImpl;
	...
	@Autowired
	public void setiEMRBeneficiaryOccupationServiceImpl(
			IEMRBeneficiaryOccupationServiceImpl iEMRBeneficiaryOccupationServiceImpl)
	{
		this.iEMRBeneficiaryOccupationServiceImpl = iEMRBeneficiaryOccupationServiceImpl;
	}

	@Autowired
	public void setiEMRBeneficiaryEducationServiceImpl(
			IEMRBeneficiaryEducationServiceImpl iEMRBeneficiaryEducationServiceImpl)
	{
		this.iEMRBeneficiaryEducationServiceImpl = iEMRBeneficiaryEducationServiceImpl;
	}

	@Autowired
	public void setiEMRBenDemographicsServiceImpl(IEMRBenDemographicsServiceImpl iEMRBenDemographicsServiceImpl)
	{
		this.iEMRBenDemographicsServiceImpl = iEMRBenDemographicsServiceImpl;
	}
	...
	public String addBeneficiaryEducation(@RequestBody String request)
	{
		...
		try
		{
			I_BeneficiaryEducation i_beneficiaryeducation = inputMapper.gson().fromJson(request,
					I_BeneficiaryEducation.class);
			I_BeneficiaryEducation i_Beneficiaryeducation = iEMRBeneficiaryEducationServiceImpl
					.addBeneficiaryEducation(i_beneficiaryeducation);
	...
	public String getBeneficiaryOccupation()
	{
		...
		try
		{
			Iterable<I_BeneficiaryOccupation> beneficiaryOccupations = iEMRBeneficiaryOccupationServiceImpl
	...
	public String getBeneficiaryEducation()
	{
		...
		try
		{
			Iterable<I_BeneficiaryEducation> beneficiaryeducations = iEMRBeneficiaryEducationServiceImpl
					.getBeneficiaryEducation();
	...
	@CrossOrigin()
	@ApiOperation(
			value = "This will save information requested by the beneficiary during call",
