...
@EnableJpaRepositories(entityManagerFactoryRef = "entityManagerFactory", basePackages = {"com.iemr.helpline1097","com.iemr.helpline1097.repository"})
...
//		logger.info(encryptor.decrypt(ConfigProperties.getPropertyByName("encDbPass")));
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder builder,
		...
		return builder.dataSource(dataSource).packages("com.iemr.helpline1097.*","com.iemr.helpline1097.repository.*").persistenceUnit("db_iemr").build();
	}
